...
public class BuyMenu {
	...
	public BuyMenu(Shop main) {

		this.main = main;
		utils = new Utils();
		lib = new RedLib();
		config = new Configuration(main, main.parentFileName + "/Inventories", "BuyMenu").getConfig();
	}
	...
	public Inventory getPlayerFormatedBuyMenu(Player player, ShopItem shopItem) {
