...
public class BuyMoreMenu {
	...
	public BuyMoreMenu(Shop main) {

		this.main = main;
		utils = new Utils();
		lib = new RedLib();
		config = new Configuration(main, main.parentFileName + "/Inventories", "BuyMoreMenu").getConfig();
	}
	...
	public Inventory getPlayerFormatedBuyMoreMenu(Player player, ShopItem shopItem) {
		...
		mainItem.addLore(main.settingsCFG.getStringList("Default.Type.BuyOnly.Lore"));
